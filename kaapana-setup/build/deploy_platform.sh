...
PLATFORM_VERSION="0.5.2" # Specific version or empty for dialog

CONTAINER_REGISTRY_URL="registry.gitlab.com/trongtruong2509/kaapana" # empty for local build or registry-url like 'dktk-jip-registry.dkfz.de/kaapana' or 'registry.hzdr.de/kaapana/kaapana'
